...
class BarangMasukController extends Controller
{
    ...
    function fetch()
    {
        $semua_barang_masuk = BarangMasuk::with('kategori', 'satuan')->get();

        return response()->json([
            'data' => $semua_barang_masuk
        ]);
    }
    ...
    public function simpan(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            'barang_masuk' => 'required|unique:barang_masuks,nama_barang_masuk',
            'kategori' => 'required',
            'satuan' => 'required',
        ]);
        ...
        $barang_masuk->nama_barang_masuk = $request->barang_masuk;
        $barang_masuk->kategori_id = $request->kategori;
        $barang_masuk->satuan_id = $request->satuan;
    ...
    public function update(Request $request, $id)
    {
        // Validate the request data
        $validator = Validator::make($request->all(), [
            'barang_masuk' => 'required|unique:barang_masuks,nama_barang_masuk,' . $id,
            'kategori' => 'required',
            'satuan' => 'required',
        ]);
