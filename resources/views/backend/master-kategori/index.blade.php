...
@section('content')
    ...
    <script>
        ...
        function fetchData() {
            $.ajax({
                url: '{{ route('master-kategori-fetch') }}',
                type: 'GET',
                dataType: 'json',
        ...
        function deleteData(id) {
            if (confirm('Apakah anda yakin ingin menghapus data ini?')) {
                ...
                $.ajax({
                    url: '{{ url('master-kategori/hapus') }}/' + id,
                    type: 'get',
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
        ...
        $('#formTambahData').on('submit', function(e) {
            ...
            if (id == '') {
                $.ajax({
                    url: '{{ route('master-kategori-simpan') }}',
                    type: 'POST',
                    data: formData,
                    contentType: false,
                    processData: false,
                ...
                $.ajax({
                    url: '{{ url('master-kategori/update') }}/' + id,
                    type: 'POST',
                    data: formData,
                    contentType: false,
                    processData: false,
        ...
        function editData(id) {
            $.ajax({
                url: '{{ url('master-kategori/edit') }}/' + id,
                type: 'get',
                data: {
                    _token: '{{ csrf_token() }}'
                },
